...
module.exports = {
    ...
    outlookLogin: function () {
        ...
        browser.sleep(data.application.waitTime.default);
        element(by.id(repo.outlookLogin.textboxes.username.id)).sendKeys(data.outlook.credentials.one.username);
        element(by.id(repo.outlookLogin.textboxes.password.id)).sendKeys(data.outlook.credentials.one.password);
        element(by.xpath(repo.outlookLogin.buttons.signIN.xpath)).click();
        browser.sleep(data.application.waitTime.default);
