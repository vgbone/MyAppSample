...
module.exports = {
    ...
    ClicksOnAddressesSidebar: function() {
        element(by.xpath(repo.documents.buttons.addresses.xpath)).click();
    },
    SelectsAnAddressAndOpensIt: function() {
        element(by.xpath(repo.documents.buttons.opensAddressSelection.xpath)).click();
    },
    ClicksOnAttenion: function() {
        element(by.xpath(repo.documents.buttons.attention.xpath)).click().clear().sendKeys('Do I have you attention!!');
    },
    ClicksAndAddsAPrimaryNumber: function() {
        element(by.xpath(repo.documents.buttons.primaryNumber.xpath)).click().clear().sendKeys('5655 867 5309');
    },
    ClicksOnEmailTextarea: function() {
        element(by.xpath(repo.documents.buttons.emailTextarea.xpath)).click().clear().sendKeys('mejohn@gmail.com');
    },
    ClicksOnNotesSectionAndInsertsText: function() {
        element(by.xpath(repo.documents.buttons.notesArea.xpath)).clear().sendKeys('This is where you put the notes for this section');
    },
    // ClicksOnSave1Button: function() {

    // },
    ClicksOnAdminstrationSidebar: function() {
        element(by.xpath(repo.documents.buttons.adminstration.xpath)).click();
    },
    ClicksOnPlusSign: function() {
        element(by.xpath(repo.documents.buttons.plusSignAdmin.xpath)).click();
    },
    ClicksOnselectMemberDropdown: function() {
        element(by.xpath(repo.documents.buttons.selectMemberDD.xpath)).click();
    },
    SelectsAMember: function() {
        element(by.xpath(repo.documents.buttons.selectMember.xpath)).click();
    },
    ClicksOnSelectOfficeDropdown: function() {
        element(by.xpath(repo.documents.buttons.officeDropdown.xpath)).click();
    },
    SelectsAnOffice: function() {
        element(by.xpath(repo.documents.buttons.selectsOffice.xpath)).click();
    },
    ClicksOnSelectRoleDropdown: function() {
        element(by.xpath(repo.documents.buttons.roleDropdown.xpath)).click();
    },
    SelectsARole: function() {
        element(by.xpath(repo.documents.buttons.selectsRole.xpath)).click();
    },
    ClicksOnHistoryInSidebar: function() {
        element(by.xpath(repo.documents.buttons.selectsHistory.xpath)).click();
    },
    ClicksOnNew1Button: function() {
