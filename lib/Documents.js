...
module.exports = {
    ...
    ClickOnDocumentLeavingCursorOnSignatureBoxArea: function() {
        ...
        browser.switchTo().frame(browser.findElement(by.xpath('//iframe[@id="ui-tinymce-1_ifr"]'))) //switches to different iframe
            //browser.findElement(by.css('.sign-field')).click()
        browser.findElement(by.id(repo.documents.textfields.text_area.id)).click().then(function() {
