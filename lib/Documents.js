...
module.exports = {
    ...
    ModifyNewPersonInfo: function() {
        element(by.xpath('//*[@id="Document-List"]/tbody/tr[1]/td[2]')).click()
            .then(function() {
                browser.sleep(5000);
            })
    },
    ...
    ModifiesFirstName: function() {
        element(by.model(repo.documents.textfields.modifiedFirstName.model)).click().clear().sendKeys('Johnny')
            .then(function() {
                browser.sleep(4000);
            })
    },
    ModifiesMiddleName: function() {
        element(by.model(repo.documents.textfields.modifiedFirstName.model)).click().clear().sendKeys('B');
    },
    ModifiesLastName: function() {
        element(by.model(repo.documents.textfields.modifiedLastName.model)).click().clear().sendKeys('Good');
    },
    ModifiesEmail: function() {
        element(by.model(repo.documents.textfields.modifiedEmail.model)).click().clear().sendKeys('johhneybgood@mailinator.com');
    },
    ...
    ModifiesBio: function() {
        element(by.xpath(repo.documents.textfields.modifiedBioSection.xpath)).clear().sendKeys('This is where the modified information goes.').then(function() {
            browser.sleep(4000);
        })
    },
    ...
    ModifiesStatus: function() {
        element(by.xpath('//*[@id="profileForm"]/div/div/div/div[2]/div[1]/div/div/button')).click()
            .then(function() {
                element(by.xpath('//*[@id="profileForm"]/div/div/div/div[2]/div[1]/div/div/ul/li[2]/a')).click();
            })
    }
}