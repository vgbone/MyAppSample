...
module.exports = {
    ...
    CanViewOnly: function() {
        ...
        element(by.model('newUser')).sendKeys(data.credentials.emailFour);//enter text into 'enter email address' textbox
    ...
    validateCanViewOnly: function() {
        ...
        expect(title).to.equal(data.testCanViewOnly.exp_title);
        });
    },
    ...
    CanEdit: function() {
        ...
        element(by.model('newUser')).sendKeys(data.credentials.emailTwo);//enter text into 'enter email address' textbox
    ...
    validateCanEdit: function() {
        ...
        browser.getTitle().then(function(title) {
        expect(title).to.equal(data.testCanEdit.exp_title);
         });
    },
    ...
    AllAccess: function() {
        ...
        element(by.model('newUser')).click();//click on textbox 'enter email address'
        element(by.model('newUser')).value = "";//clear text field
        element(by.model('newUser')).sendKeys(data.credentials.emailThree);//enter text into 'enter email address' textbox
    ...
    validateAllAccess: function() {
        ...
        browser.getTitle().then(function(title) {
        expect(title).to.equal(data.testAllAccessd.exp_title);
         });
    },
