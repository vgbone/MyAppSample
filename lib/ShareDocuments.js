...
module.exports = {
    ...
    CanViewOnly: function() {
        ...
        element(by.xpath("//DIV[@class='img-circle-bg invite-icon pull-left']")).click().then(function() {
            ...
            browser.findElement(by.xpath("//TD[@class='ng-binding'][text()='paperautotest1@outlook.com']")).isDisplayed() mail address ' textbox
        }).then(function() {
    ...
    CanEdit: function() {
        element(by.model('newUser')).click().then(function() {
            ...
            browser.findElement(by.xpath("//TD[@class='ng-binding'][text()='paperautotest2@outlook.com']")).isDisplayed()
        }).then(function() {
